function calcularMatriz(f_matriz) {
	var Linhas = f_matriz.length - 1;
	var Colunas = f_matriz[Linhas].length - 1;

	// Decidindo qual variável entra na base
	...
	// Decidindo qual variável básica sai
	...
	var var_entra = f_matriz[0][indMaior];
	var var_sai = f_matriz[indMenor][0];
	document.getElementById("tab").innerHTML+="<p>Troca Base: entra "+var_ent.substr(0,1)+"<sub>"+var_ent.substr(1,1)+"</sub> e sai "+var_sai.substr(0,1)+"<sub>"+var_sai.substr(1,1)+"</sub></p>";
